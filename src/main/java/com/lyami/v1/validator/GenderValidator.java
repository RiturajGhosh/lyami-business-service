...
import com.lyami.v1.dto.request.UserBusinessDetailsRegistrationRequest.Gender;
...
public class GenderValidator implements ConstraintValidator<ValidGender, Gender> {
    ...
    public boolean isValid(Gender value, ConstraintValidatorContext context) {
        return  (value == null || value.equals(Gender.MALE) || value.equals(Gender.FEMALE) || value.equals(Gender.OTHER)) ? true : false;
    }
