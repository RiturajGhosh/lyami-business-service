...
@Slf4j
public abstract class UserBusinessDetailsMapper {
    ...
    Address mapAddressRequest(UserProfileAddressRequest userRegistrationAddressRequest) {
        if(userRegistrationAddressRequest == null) return null;
    ...
    public abstract UserBusinessDetails mapUserProfileUpdateReqtoEntity(UserBusinessDetailsUpdateRequest userBusinessDetailsUpdateRequest);

    @Mapping(target = "address", source = "address",  qualifiedByName = "mapAddressRequest")
    //@Mapping(target = "country", source = "country",  qualifiedByName = "mapCountry")
    public abstract UserBusinessDetails mapUserProfileRegistrationReqtoEntity(UserBusinessDetailsRegistrationRequest userRegistrationRequest);

    @Mapping(target = "address", source = "address",  qualifiedByName = "mapAddressResponse")
